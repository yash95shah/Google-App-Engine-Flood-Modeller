...
def query_fetch(collection, record ):
    ...
    key_to_get = dsagent.key(collection, record)    #making a key to get the specific dict / Entity object from the database
    val = dsagent.get(key_to_get)
    return val     #returns an entity/ dictionary
